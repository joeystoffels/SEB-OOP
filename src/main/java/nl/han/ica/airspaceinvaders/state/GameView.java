...
import nl.han.ica.airspaceinvaders.dashboard.GameDashboard;
...
public class GameView extends View implements IState {
    ...
    public void start() {
        ...
        this.game.addGameObject(player, worldWidth / 2 - (player.getWidth() / 2), worldHeight);
...
//                this.game.addGameObject((Air) enemy, worldWidth / 3, 0);
//            }
//            if (enemy instanceof Ground) {
//                this.game.addGameObject((Ground) enemy, worldWidth / 2 - (player.getWidth() / 2), 0);
//            }
//        }
    }
